...
{
    public async Task OResultExecutionAsync(ResultExecutingContext context, ResultExecutionDelegate next)
    {
        var hasCamelCaseAttr = context.ActionDescriptor.EndpointMetadata.OfType<CamelCaseJsonAttribute>().Any();
