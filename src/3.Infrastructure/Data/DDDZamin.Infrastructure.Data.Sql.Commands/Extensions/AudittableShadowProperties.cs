...
public static class AudittableShadowProperties
{
    ...
    public static void AddAudittableShadowProperties(this ModelBuilder modelBuilder)
    {
        foreach (var entityType in modelBuilder.Model
                     .GetEntityTypes()
                     .Where(c=>typeof(IAuditableEntity)
