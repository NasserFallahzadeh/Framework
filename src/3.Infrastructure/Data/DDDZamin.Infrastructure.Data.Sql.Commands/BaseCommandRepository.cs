...
IFormattable
{
    ...
    {
        return _dbContext.Set<TEntity>().FirstOrDefault(e => e.BusinessId == businessId);
    }
    ...
    {
        return await _dbContext.Set<TEntity>().FirstOrDefaultAsync(e => e.BusinessId == businessId);
    }
    ...
    public TEntity GetGraph(BusinessId businessId)
    {
        ...
        return query.FirstOrDefault(e => e.BusinessId == businessId);
    }
    ...
    public async Task<TEntity> GetGraphAsync(BusinessId businessId)
    {
        ...
        query = graphPath.Aggregate(query, (current, item) =>
