...
/// <summary>
/// نتیجه انجام عملیات به کمک این کلاس بازگشت داده می‌شود.
/// دلایل استفاده از این الگو و پیاده سازی کاملی از این الگو را در لینک زیر می‌توانید مشاهده کنید
/// https://github.com/vkhorikiv/CqrsInPractice
/// </summary>
...
/// دلایل استفاده از این الگو و پیاده‌سازی کاملی از این الگو را در لینک زیر می‌توانید مشاهده کنید
/// این ساختار در صورتی استفاده می‌شود که برای عملیات مقدار خروجی نیاز باشد.
/// https://github.com/vhkorikov/CqrsInPractice
/// </summary>
