...
/// تعریف کاملی این الگو در کتاب P of EAA وجود دارد و تعریف اولیه را در آدرس زیر می‌توام مشاهده کرد
...
public interface IUnitOfWork
{
    ...
    /// <summary>
    /// برای تأیید تراکنشی که اتوماتیک توسط سیستم ایجاد شده است از این متد استفاده می‌شود.
    /// </summary>
    /// <returns></returns>
    int Commit();
