...
public static class PersianNumbersUtils
{
    ...
    public static string ToPersianNumbers(this int number, string format = "")
    {
        return !string.IsNullOrEmpty(format)
            ...
            : number.ToString(CultureInfo.InvariantCulture).ToPersianNumbers();
    }
    ...
    public static string ToPersianNumbers(this long number, string format = "")
    {
        return (!string.IsNullOrEmpty(format)
            ? number.ToString(format)
            : number.ToString(format).ToPersianNumbers());
    }
    ...
    public static string ToPersianNumbers(this long? number, string format = "")
    {
        ...
        return !string.IsNullOrEmpty(format)
            ? number.Value.ToString(format)
            : number.Value.ToString(CultureInfo.InvariantCulture).ToPersianNumbers();
    }
